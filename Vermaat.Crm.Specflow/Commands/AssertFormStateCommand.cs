...
namespace Vermaat.Crm.Specflow.Commands
{
    public class AssertFormStateCommand : BrowserOnlyCommand
    {
        ...
        public AssertFormStateCommand(ICrmTestingContext crmContext, ISeleniumTestingContext seleniumContext, EntityReference crmRecord, Table visibilityCriteria) :
